...
class Car:
    def __init__(self, canvas):
        ...
        self.canvas = canvas
        self.Image1 = PhotoImage(file="~/Desktop/Python/Assets/Drive to Survive/redcar.gif")
...
class Badcar:                                                      #The badcars are the blue cars that are going the opposite way as you that you need to avoid.
    def __init__(self, canvas, x_positions, car, gameover):
        ...
        self.car = car
        self.canvas = canvas
        self.Image2 = PhotoImage(file="~/Desktop/Python/Assets/Drive to Survive/bluecar.gif")
